    ...
    return (
      <Container>
        ...
        <Right>
          <Title>Contact</Title>
          <ContactItem>
            <Room style={{marginRight:"10px"}}/> VIT Vellore, Katpadi, Vellore
          </ContactItem>
          <ContactItem>
            <Phone style={{marginRight:"10px"}}/> +999 99 99 999
          </ContactItem>
          <ContactItem>
            <MailOutline style={{marginRight:"10px"}} /> tuhinchakrabarty14@gmail.com
          </ContactItem>
